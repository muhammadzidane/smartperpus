                ...
                <div class="{{ $modal_trigger }}">
                    ...
                    <div class="form-group mx-auto mt-4">
                        <div class="">
                            ...
                            <select class="form-control-custom provinsi" name="provinsi">
                                ...
                                <option {{ \App\Models\Province::find(old('provinsi') ?? 1)->name == $province->name ? 'selected' : '' }} value="{{ $province->id }}">{{ $province->name }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group mx-auto mt-4">
                        <div class="">
                            ...
                            <input min="0" type="number" name="nomer_handphone" class="form-control-custom book-edit-inp" value="{{ old('nomer_handphone') }}">
