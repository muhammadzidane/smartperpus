...
<div class="register-user py-4">
    ...
    <form id="user-edit-form" data-id="{{ $user->id }}"
      ...
      <div class="text-right p-0"><a href="{{ url()->previous() }}"><i class="fas fa-long-arrow-alt-left text-body"></i></a></div>
        ...
        <div class="d-flex flex-wrap">
            ...
            <div class="form-group w-100">
                <label for="tanggal_lahir">Tanggal Lahir <small class="tred-bold">(Boleh kosong)</small></label>
                <input type="date" name="tanggal_lahir" id="tanggal_lahir"
                  class="form-control-custom"
                  value="{{ $user->getRawOriginal('date_of_birth') }}">
            ...
            <div class="form-group w-100">
                <label for="nomer_handphone">Nomer Handphone <small class="tred-bold">(Boleh kosong)</small></label>
                <input type="number" name="nomer_handphone" id="nomer_handphone"
                  class="form-control-custom user-edit-inp"
                  value="{{ $user->phone_number ?? old('nomer_handphone') }}">
        ...
        <div class="tred-bold">Tanda * berarti kolom wajib di isi</div>
