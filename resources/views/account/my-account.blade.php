...
<div class="row d-md-flex mt-md-4">
    <div class="col-lg-9 d-lg-flex">
        <div class="white-content px-0 pt-0 pb-4 m-0 borbot-gray-bold">
            <div class="container-lg pt-4">
                <div class="container-lg d-md-flex pb-4 borbot-gray-0">
                    <div class="change-profile-img">
                        <div class="d-flex flex-column">
                            ...
                            <div class="mt-5">
                                <button id="add-account-photo" type="button" class="btn btn-sm btn-outline-yellow w-100">
                    ...
                    <div class="d-flex flex-column w-100">
                        <div class="ml-md-5 overflow-auto">
                            <table class="account-table">
                                <tr>
                                    <th>Nama</th>
                                    <td>Muhammad Zidane Alsaadawi</td>
                                ...
                                <tr>
                                    <th>Email</th>
                                    <td>muhammmadzidanealsaadawi@gmail.com</td>
                                    <td><button type="button" class="btn-none p-0 tred-bold">Ubah</button></td>
                                </tr>
                                <tr>
    ...
    @include('account.purchases-and-inboxes')
</div>
