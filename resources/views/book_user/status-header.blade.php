<div class="white-content-0 borbot-gray-bold">
    <div class="white-content-header-2">
        <div>
            ...
            <a href="#" class="ml-3 text-grey tbold text-decoration-none {{ $confirmed ?? '' }}">Order Yang Terkonfirmasi</a>
            <a href="#" class="ml-3 text-grey tbold text-decoration-none {{ $being_shipped ?? '' }}">Sedang di Kirim</a>
            <a href="#" class="ml-3 text-grey tbold text-decoration-none {{ $arrived ?? '' }}">Telah Sampai</a>
            <a href="{{ route('uploaded.payment.histories') }}" class="ml-3 text-grey tbold text-decoration-none {{ $history ?? '' }}">Riwayat</a>
        </div>
    </div>
</div>
