...
@include('book_user.status-header', array('uploaded_payment' => 'text-body'))

@forelse (App\Models\BookUser::where('upload_payment_image', '!=', null)
->where('payment_status', 'waiting_for_confirmation')->get() as $book_user)
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between flex-column h-100">
                    <div>
                        ...
                        <div>Total pembelian <span>({{ $book_user->amount }})</span></div>
                        <div class="d-flex justify-content-between">
