            ...
            <div class="white-content m-0 borbot-gray-bold">
                <div class="row">
                    <div class="col-md-3 mb-5">
                        <img class="zoom-modal-image book-status-image" src="{{ asset('storage/uploaded_payment/' . $book_user['book_user']->upload_payment_image) }}">
                    </div>
                    <div class="col-md-9">
                        <div class="d-flex justify-content-between flex-column h-100">
                            ...
                            <div class="d-md-flex justify-content-between mt-auto pt-3">
                                <button class="see-billing-list btn-none p-0 mt-2 tred tred-bold" data-toggle="modal" data-id="{{ $book_user['book_user']->id }}" data-target="#bill">Lihat Detail</button>
                                <div class="text-right">
                                    <button data-id="{{ $book_user['book_user']->id }}" class="confirm-process btn btn-red">Konfirmasi Proses</button>
                                    <button class="cancel-process-confirmation btn-none tred-bold" data-id="{{ $book_user['book_user']->id }}">Batalkan</button>
                                </div>
                            </div>
                        </div>
                    </div>
